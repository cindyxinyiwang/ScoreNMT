...
for i in ${!ILS[*]}; do
  ...
  echo $IL
  echo $DATA
  for f in  $TEMP_DIR/uniform-cosine-zero_one $TEMP_DIR/uniform-cosine-one $TEMP_DIR/uniform $TEMP_DIR/hs $TEMP_DIR/hs-cosine-lan_dist $TEMP_DIR/hs-cosine-one $TEMP_DIR/hs-cosine-zero_one; do
